      ...
      <Layout>
        ...
        <section className="my-12 sm:my-24">
          <h2 className="text-2xl text-center">
            Pasos y requisitos para empeñar tu auto
          </h2>
        ...
        <section id="solicitud-avaluo" className="my-12 sm:my-24">
            ...
            <FormContainer>
              <div className="text-center mb-8">
                ...
                <p className="text-secondary text-sm">
                  Conoce cuanto te prestamos por tu auto. A la brevedad un representante se comunicara contigo
                </p>
              </div>
