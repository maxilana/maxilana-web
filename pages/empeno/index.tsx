      ...
      <Layout>
        ...
        <section className="my-12 max-w-5xl mx-auto sm:my-24">
          <h2 className="text-2xl text-center">
            Así de fácil es empeñar en Maxilana
          </h2>
        ...
        <section className="my-12 max-w-4xl mx-auto sm:my-24 sm:px-32">
          <h2 className="text-2xl text-center">
            Pasos para empeñar en Maxilana
          </h2>
          <div className="my-12">
        ...
        <section className="my-12 sm:my-24 sm:px-32">
          <h2 className="text-2xl text-center">
            Recibe más beneficios por empeño
          </h2>
...
const steps = [
  {
    ...
    description: "Recibimos casi cualquier artículo. Laptops, Joyas, Electrodomesticos, Linea Blanca, Videojuegos. No olvides tu identificación."
  },
  {
    id: 2,
    imageSrc: "/svg/icono-lupa.svg",
    title: "Evaluamos tu artículo",
    description: "Nuestro valuador experto, valuara las condiciones de tu prenda y el valor que que tiene."
  },
  {
    id: 3,
    imageSrc: "/svg/icono-billete.svg",
    title: "Recibe tu dinero",
    description: "El artículo se guarda y se asegura en nutras instalaciónes. Puedes recogerlo cuando pagues el desempeño o refrendar el préstamo las veces que quieras"
  },
];
...
const benefits = [
  {
    ...
    description: "Sabemos que tus prendas valen oro. Es por eso que en Maxilana te damos más por tu empeño."
  },
  {
    id: 2,
    imageSrc: "/svg/icono-tarjeta-credito.svg",
    title: "Paga más comodamente",
    description: "Paga en línea o en cualquier sucursal. Elige el método de abono que más te convenga."
  },
  {
    id: 3,
