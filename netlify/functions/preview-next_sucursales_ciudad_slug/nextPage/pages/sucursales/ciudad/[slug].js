...
;// CONCATENATED MODULE: ./api/getCityBranchesBySlug.ts


const getCityBranchesBySlug = async slug => {
  const response = await axios/* default.get */.Z.get(`/sucursales?ciudad=${slug}`);
  return response.map(item => ({
    ...
    CityId: item === null || item === void 0 ? void 0 : item.ciudad,
...
/* harmony default export */ var api_getCityBranchesBySlug = (getCityBranchesBySlug);
// EXTERNAL MODULE: ./components/layout/index.ts
var layout = __webpack_require__(19115);
;// CONCATENATED MODULE: ./api/getAllCities.ts


const getAllCities = async () => {
  const response = await axios/* default.get */.Z.get('/ciudades');
  return response.map(item => ({
    id: item === null || item === void 0 ? void 0 : item.id,
...
/* harmony default export */ var api_getAllCities = (getAllCities);
// EXTERNAL MODULE: ./components/Branches/index.ts
var Branches = __webpack_require__(58464);
// EXTERNAL MODULE: ./utils/slugify.ts
var slugify = __webpack_require__(32105);
;// CONCATENATED MODULE: ./pages/sucursales/ciudad/[slug].tsx
...
const getStaticPaths = async () => {
  const cities = await api_getAllCities();
  const slugs = cities.map(city => (city === null || city === void 0 ? void 0 : city.slug) || (0,slugify/* default */.Z)(city.name));
  return {
...
const getStaticProps = async ctx => {
  ...
  const branches = currentCity ? await api_getCityBranchesBySlug(slug) : [];
  return {
    props: {
      cities,
      branches,
...
const Index = props => {
  return /*#__PURE__*/jsx_runtime.jsx(layout/* Layout */.Ar, {
    title: "Sucursales",
    children: /*#__PURE__*/jsx_runtime.jsx(Branches/* BranchesMap */.aA, _objectSpread({}, props))
  });
};

/* harmony default export */ var _slug_ = (Index);
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(62201)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [4322,9293,446,4651,8647,9991,1428,2474,8343,2481,4095,7307,629,6324,5280,2667,4474,3382,6675,1417], function() { return __webpack_require__(69109); })
